...
const socials = [
    {
        ...
        handle: "Khoa Lam",
        description: "Inspiration chasing technologist. Craftsman of clarity. Advocate for style points.",
    ...
    },
    {
        ...
        handle: "Erik Danford",
        description: "Multifaceted engineer. Torchbearer of tinkering tenets. Fixes anything from bugs to boats.",
						...
						<Card>
							...
							>
								...
								<div className="z-10 flex flex-col items-center">
                                    {/* Display photo */}
                                    <img src={s.photo || '/path/to/default.jpg'} alt={s.handle} className="w-24 h-24 rounded-full mb-4" />
